...
import edu.timetracker.service.RewardService;
...
public class TimeKeeperTest {
	...
	public class FindCreatedUser {
		...
		public void setUp() {
			...
			keeper = new TimeKeeper(userService);
		}
		
		@Test
		@DisplayName("Then user exists on finding")
		public void testFindUser() {
			User savedUser = userService.findUser(user.getId()).get();
	...
	public class FindNonExistingUser {
		...
		public void testFindUser() {
			NoSuchElementException exception = assertThrows(NoSuchElementException.class, () -> {
				userService.findUser(user.getId()).get();
			});
	...
	public class GetResultStatus {
		...
		public void testFindUser() {
			RewardService service = keeper.getRewardStatus(user.getId());
			assertEquals(RewardStatus.MARATHONER, service.getRewardStatus());
		}
	}
